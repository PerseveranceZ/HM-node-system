      ...
      <el-form autoComplete="on" :model="loginForm" :rules="loginRules"
        ...
        <el-form-item prop="password">
          ...
          <span class="show-pwd" @click="showPwd">
            <svg-icon icon-class="eye" v-if="pwdType=='password'"/>
            <svg-icon icon-class="eye-o" v-else/>
          </span>
        </el-form-item>
        <el-form-item>
...
<script>
  ...
  import login_background from '@/assets/login/login-background.png'
  export default {
    name: 'login',
    data() {
